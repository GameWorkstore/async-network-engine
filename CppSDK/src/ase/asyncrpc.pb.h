...
enum Transmission : int {
  ...
  Transmission_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Transmission_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class GenericRequest final :
 ...
 public:
  ...
  void set_messege(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_messege(const std::string& value);
...
void GenericRequest::set_messege(ArgT0&& arg0, ArgT... args) {
 
 _impl_.messege_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void GenericRequest::set_allocated_messege(std::string* messege) {
  ...
  _impl_.messege_.SetAllocated(messege, GetArenaForAllocation());
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GenericResponse::set_messege(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GenericErrorResponse::set_error(ArgT0&& arg0, ArgT... args) {
